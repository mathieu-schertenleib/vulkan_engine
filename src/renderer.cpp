...
inline constexpr auto offscreen_vertex_shader_path =
    "shaders/spv/offscreen.vert.spv";
inline constexpr auto offscreen_fragment_shader_path =
    "shaders/spv/offscreen.frag.spv";
inline constexpr auto final_vertex_shader_path = "shaders/spv/final.vert.spv";
inline constexpr auto final_fragment_shader_path = "shaders/spv/final.frag.spv";
inline constexpr auto texture_path = "assets/texture.jpg";
